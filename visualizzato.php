...
<div class="page-header" style="border-bottom: none">
  <h1 style=" text-align: center; font-size: 47px; color: white;">I tuoi viaggi di <?php echo $nomefile ?> 2019</h1>
</div>
<!--<div id="tablePanelBody" class="panel-body" style="opacity: 0.9; border-radius: .25rem"> -->
...
<div style="width: 40%; margin-left: 30%;" class="input-group">
	
<form action="caricaViaggio.php" method="get">
  <input style="background-color: #fff; border-radius: .5rem"  type="submit" class="form-control" value="Carica viaggio" id="basic-url" aria-describedby="basic-addon3">
</form></div>
<br style="padding: 1px 9px;">
