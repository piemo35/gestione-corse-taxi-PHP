...
<div class="page-header">
  <h1 style=" text-align: center; font-size: 40px"><span style="font-size: 50px; color: white" class="glyphicon glyphicon-usd" aria-hidden="true"></span><br><small style="color: white;">Scegli il mese</small></h1>
</div>

<form method="post" action="netto.php">
